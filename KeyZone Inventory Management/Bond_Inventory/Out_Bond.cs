    ...
    public partial class Out_Bond : Form
    {
        ...
        private void Out_Bond_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd21 = new SqlCommand("select isnull((Max(Bond_No)+1),1) as max from Out_Bond where myear=@myear", con);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1001 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void max()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1002 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Bond_No_KeyPress_1(object sender, KeyPressEventArgs e)
        {
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar))
            {
                e.Handled = true;
        ...
        private void textBox_Item_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1003 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Unit_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1004 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Stores_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1005 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Cost_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1007 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Sum_TotalGrid()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1008 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Delete_Row_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1009 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void flag_endDate()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1010 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1011 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void QauntityCC2()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1012 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void SelectUnit_Rate()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1013 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Data_ADD_Rows()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1014 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Item_No_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1015 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1016 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);

            }
        }

        private void Out_Bond_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                SendKeys.Send("{TAB}");
        ...
        private void ADD_Row()
        {
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    cmd.CommandText = "SP_ADD_Out_Bond";
                    ...
                    cmd.Parameters.AddWithValue("@R_Stores_No", dataGridView1.Rows[i].Cells[4].Value);
                    ...
                    cmd.Parameters.AddWithValue("@Doc_Type", Class_Pro.ID_Out_Bond);
                    cmd.Parameters.AddWithValue("@Screen_Code", Class_Pro.ID_Out_Bond);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1017 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd22 = new SqlCommand("select DISTINCT Bond_No from Out_Bond where Bond_No=@Bond_No and MYear=@MYear", con);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1018 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Delete_Row()
        {
            try
            {
                ...
                cmd.CommandText = "SP_DELETE_Out_Bond";
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1019 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void addScren()
        {
            ...
            {
                con.Open();
                SqlCommand cmd21 = new SqlCommand("select top 1 * from Out_Bond where Bond_No=@Bond_No and Myear=@Myear", con);
                ...
                con.Open();
                dataGridView1.Rows.Clear();
                SqlCommand cmd = new SqlCommand("select R_Item_No,R_Item_Name,R_Unit_No,R_Unit_Name,R_Stores_No, R_Stores_Name, R_Quantity,R_Cost,R_Total,R_End_Date from Out_Bond where Bond_No=@Bond_No", con);
                cmd.Parameters.Add(new SqlParameter("@Bond_No", textBox_Bond_No.Text));
                SqlDataReader dr2;
                dr2 = cmd.ExecuteReader();
                while (dr2.Read())
                {
                    dataGridView1.Rows.Add(dr2["R_Item_No"].ToString(), dr2["R_Item_Name"].ToString(), dr2["R_Unit_No"].ToString(), dr2["R_Unit_Name"].ToString(), dr2["R_Stores_No"].ToString(), dr2["R_Stores_Name"].ToString(), dr2["R_Quantity"].ToString(), dr2["R_Cost"].ToString(), dr2["R_Total"].ToString(), dr2["R_End_Date"].ToString());
                    Sum_TotalGrid();
                }
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1020 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void DELETE_Row_i2_Trans()
        {
            try
            {
                ...
                cmd.CommandText = "SP_DELETE_Out_Bond_i2_Trans";
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1021 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ADD_Row_i2_trans()
        {
            try
            {
                ...
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    cmd.CommandText = "SP_ADD_Row_Out_Bond_i2_trans";
                    ...
                    cmd.Parameters.AddWithValue("@S_Name", 0);
                    cmd.Parameters.AddWithValue("@Note", textBox_Note.Text);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1022 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_P_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Print == 1)
                {
                    ...
                    FRM_Report_Out_Bond.fRM_Report.textBox_Bond_No.Text = printNo.ToString();
                    FRM_Report_Out_Bond.fRM_Report.textBox_Year.Text = textBox_Year.Text;
                }
                Print = 0;
            }
            catch (Exception ee)
        ...
        private void btn_Delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (MessageBox.Show("هل انت متاكد من عملية الحذف", "حذف سجل", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    MessageBox.Show("تم حذف المستند بنجاح", "عملية صحيحة", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                    clear_screen();
                    Out_Bond_Load(sender, e);
                }
            }
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1027 Out_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
