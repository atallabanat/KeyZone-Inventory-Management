...
namespace KeyZone_Inventory_Management.Bond_Inventory
{
    public partial class Destruction_Bond : Form
    {
        ...
        //public virable
        public static Destruction_Bond Destruction_B;
        double Quntity = 0;
        double Cost = 0;
        int NewRow = 0;
        double Unit_Rate;
        ...
        private void Destruction_Bond_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd21 = new SqlCommand("select isnull((Max(Bond_No)+1),1) as max from Destruction_Bond where Myear=@myear", con);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1001 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void max()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1002 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ADD_Row()
        {
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    cmd.CommandText = "SP_ADD_Destruction_Bond";
                    ...
                    cmd.Parameters.AddWithValue("@Doc_Type", Class_Pro.ID_Destruction_Bond);
                    cmd.Parameters.AddWithValue("@Screen_Code", Class_Pro.ID_Destruction_Bond);
                ...
                MessageBox.Show("تم اضافة الطلب  بنجاح بالرقم " + textBox_Bond_No.Text + "", "عملية صحيحة", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            catch (Exception ee)
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1003 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Delete_Row()
        {
            try
            {
                ...
                cmd.CommandText = "SP_DELETE_Destruction_Bond";
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1004 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Destruction_Bond_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btn_Unit_Click(object sender, EventArgs e)
        {
            ...
            {
                Grid_Unit.SCR_Destruction_Bond = true;
                Grid_Unit grid_Unit = new Grid_Unit();
                grid_Unit.ShowDialog();
                Grid_Unit.SCR_Destruction_Bond = false;
            }
        }

        private void button3_Click(object sender, EventArgs e)
        {
            Grid_Stores.SCR_Destruction_Bond = true;
            Grid_Stores grid_Stores = new Grid_Stores();
            grid_Stores.ShowDialog();
            Grid_Stores.SCR_Destruction_Bond = false;
        }
        ...
        private void textBox_Item_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1005 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Stores_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1007 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Sum_TotalGrid()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1008 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Delete_Row_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1009 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void flag_endDate()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1010 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void SelectUnit_Rate()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1011 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBox_Stores_No.Text != "")
                {
                    ...
                    {
                        MessageBox.Show(" عذرا الكمية غير كافية ، الكمية المتواجدة في هذا المستودع  " + QauntityCC + "  والكمية المراد إتلافها   " + ALLQauntity);
                        return;
                    }
                }
                else
                {
                    MessageBox.Show("يرجى تحديد المستودع المراد إتلاف المادة منه");
                    return;
                }
                //--------------------------------------------------------------------------------------------------------------------------------------------------------------
                Data_ADD_Rows();
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1012 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void QauntityCC2()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1013 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void Data_ADD_Rows()
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1014 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Item_No_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1015 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void dataGridView1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1016 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        public void addScren()
        {
            ...
            {
                con.Open();
                SqlCommand cmd21 = new SqlCommand("select top 1 * from Destruction_Bond where Bond_No=@Bond_No and Myear=@Myear", con);
                ...
                con.Open();
                dataGridView1.Rows.Clear();
                SqlCommand cmd = new SqlCommand("select R_Item_No,R_Item_Name,R_Unit_No,R_Unit_Name,R_Sores_No, R_Stores_Name, R_Quantity,R_Cost,R_Total,R_End_Date from Destruction_Bond where Bond_No=@Bond_No", con);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1017 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void DELETE_Row_i2_Trans()
        {
            try
            {
                ...
                cmd.CommandText = "SP_DELETE_Destruction_Bond_i2_Trans";
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1018 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void ADD_Row_i2_trans()
        {
            try
            {
                for (int i = 0; i < dataGridView1.Rows.Count; i++)
                {
                    ...
                    cmd.CommandText = "SP_ADD_Row_Destruction_Bond_i2_trans";
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1019 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd22 = new SqlCommand("select DISTINCT Bond_No from Destruction_Bond where Bond_No=@Bond_No and MYear=@MYear", con);
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1020 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void textBox_Bond_No_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1022 Destruction_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_P_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Print == 1)
                {
                    ...
                    FRM_Report_Destruction_Bond.fRM_Report.textBox_Bond_No.Text = printNo.ToString();
                    FRM_Report_Destruction_Bond.fRM_Report.textBox_Year.Text = textBox_Year.Text;
