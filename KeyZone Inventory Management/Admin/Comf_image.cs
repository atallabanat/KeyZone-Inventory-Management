...
{
    public partial class Comf_image : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                SqlCommand cmd = new SqlCommand("update Comf set img=@img, com_name=@com_name , com_Adress=@com_Adress , com_pohne=@com_pohne , com_Fax=@com_Fax , com_year=@com_year where id=1 ", con);
        ...
        private void Comf_image_Load(object sender, EventArgs e)
        {
            try
            {
