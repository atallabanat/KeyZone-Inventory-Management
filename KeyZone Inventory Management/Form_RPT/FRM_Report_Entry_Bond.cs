...
{
    public partial class FRM_Report_Entry_Bond : Form
    {
        static string constring = ConfigurationManager.ConnectionStrings["Con"].ConnectionString;
        SqlConnection con = new SqlConnection(constring);
        public static FRM_Report_Entry_Bond fRM_Report;
        //public virable
        int bond_no;
        public FRM_Report_Entry_Bond()
        {
            fRM_Report = this;
            InitializeComponent();
        }

        private void FRM_Report_Entry_Bond_Load(object sender, EventArgs e)
        {
        ...
        private void btn_Save_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                con.Open();
                SqlCommand cmd21 = new SqlCommand("select count( *) as cc from Entry_Bond where Bond_No=@Bond_No and Myear=@Myear", con);
                ...
                Report_Entry_Bond report_Entry_Bond = new Report_Entry_Bond();
                report_Entry_Bond.Show();
            }
            catch (Exception ee)
            {
                con.Close();
                MessageBox.Show("يرجى تصوير الخطأ ومراجعة مدير النظام ، شكرا" + ee.Message, "ERROR 1001 FRM_Report_Entry_Bond", MessageBoxButtons.OK, MessageBoxIcon.Error);
        ...
        private void btn_View_Bond_No_Click(object sender, EventArgs e)
        {
            if (textBox_Year.Text != "")
            {
                Grid_Entry_Bond.SCR_FRM_Report_Entry_Bond = true;
                Grid_Entry_Bond Grid_Entry_Bond2 = new Grid_Entry_Bond();
                Grid_Entry_Bond2.ShowDialog();
                Grid_Entry_Bond.SCR_FRM_Report_Entry_Bond = false;
            }
        }
    }
}
